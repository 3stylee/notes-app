        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            await showErrorDialog(context,
                'We could not process your request, please make sure you are a registerd user.');
          }
        }
      },
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(children: [
            const Text(
                'If you forgot your password, please enter your email below and we will send you a password reset link.'),
            TextField(
